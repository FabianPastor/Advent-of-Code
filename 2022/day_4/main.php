...
function contains($e1, $e2){ return ( ($e1[0] <= $e2[0] && $e2[1] <= $e1[1]) ); }
function overlaps($e1, $e2){ return ( contains($e1, $e2) || (($e1[0] <= $e2[0] && $e2[0] <= $e1[1]) && ($e1[1] < $e2[1])) );}
...
$assignementsP1 = 0; $assignementsP2 = 0;
